  ...
  return (
    <form onSubmit={handleSubmit} className="bg-gray-800 rounded-xl border border-gray-700 p-5 space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-xs text-gray-400 mb-1">결제수단</label>
        ...
        <div>
          <label className="block text-xs text-gray-400 mb-1">결제방식</label>
        ...
        <div>
          <label className="block text-xs text-gray-400 mb-1">가맹점/내용</label>
          <input
