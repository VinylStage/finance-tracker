...
const SHAPES = [
  ...
  [/^\/api\/installments/, {
    data: [{
      ...
      remaining_months: 10, billed_months: 2, billing_ends_on: '2027-06-30',
    }],
...
const PAGES = [
  ...
  // 카드 상세(#563). 구간별로 어느 혜택이 살아 있는지를 보여주는 화면이라
  // 데이터가 없을 때도 열려야 한다 — 카드가 0장인 상태가 정상 초기 상태다.
  ['CardDetail', () => import('./CardDetail')],
