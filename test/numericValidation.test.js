...
const EXPECTED = [
  { file: 'cardBenefits.js', method: 'POST', routePath: '/', fields: ['card_product_id', 'category_id', 'monthly_cap', 'min_amount', 'max_amount', 'card_threshold_tier_id'] },
  { file: 'cardBenefits.js', method: 'PUT', routePath: '/:id', fields: ['card_product_id', 'category_id', 'monthly_cap', 'min_amount', 'max_amount', 'card_threshold_tier_id'] },
